...
dbc.Row(dcc.Tabs([dcc.Tab(label="Yearly GDP", 
                          children=[dbc.Row(dbc.Col(dcc.Dropdown(['Malaysia', 'Indonesia', 'China'], 'Malaysia', id='dropdown-country', className="mt-5"), width={"size": 4, "offset": 4})), 
dbc.Row(dcc.Graph(id="graph-scatter"))]), 
                  dcc.Tab(label="GDP by Continent", 
                          children=[dbc.Row(dbc.Col(dcc.Slider(1960, 2020, 5, value=2020, id='slider-year',
